...
<br>
<h1 class="kiesDag">Kies je dag</h1><br>
<div class="container droptainer">
<div class="row">
<div class="col-md-3"></div>
<div class="col-md-6">
<select name="dag" id="dag" class="dropdownMenu">
    <option value="" disabled="disabled" selected="selected" class="option">Dag</option>
    <option value="13mei" class="option">13 Mei</option>
    <option value="14meiMS" class="option">14 Mei - Main Stage</option>
    <option value="14meiTS" class="option">14 Mei - Techno Stage</option>
    <option value="14meiTA" class="option">14 Mei - The Academy</option>
    <option value="15mei" class="option">15 Mei</option>
  </select>
</div>
<div class="col-md-3"></div>
</div><br>
